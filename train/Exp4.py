...
# Description:
# A MiniVGGNet-based architecture trained on edge-feature-extracted 
# image datasets to analyze structural feature learning.
# ======================================================
...
plt.title('Exp4 (MiniVGGNet) - Accuracy')
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
plt.legend()
...
plt.title('Exp4 (MiniVGGNet) - Loss')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend()
plt.tight_layout()
...
plt.savefig(os.path.join(output_dir, "Exp4.png"))
plt.show()

model_dir = "../model"
os.makedirs(model_dir, exist_ok=True)
model_vgg.save(os.path.join(model_dir, "Exp4.keras"))
print("[Success] MiniVGGNet model saved successfully as Exp4.keras!")